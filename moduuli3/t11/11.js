...
// dialog.setAttribute()     //saada targetiksi img elementin joka sijaitsee dialogin sisällä

for (let pic in picArray) {
  console.log(picArray[pic]['image']["medium"]);
  console.log(picArray[pic]['image']["large"])
  ...
  const hText = picArray[pic]['title'];
  ...
  img.src = picArray[pic]['image']["medium"]
  img.alt = picArray[pic]['title']
  const figureCaption = document.createElement('figcaption')
  figureCaption.textContent += picArray[pic]['caption']
  console.log(figureCaption.textContent)
  figure.appendChild(img)
  figure.appendChild(figureCaption)

  const paragraf = document.createElement('p')
  paragraf.textContent += picArray[pic]['description']
  ...
  article.addEventListener("click", function (evt){
    const imgL = document.querySelector('dialog img')
    imgL.src = picArray[pic]['image']["large"]
    imgL.alt = picArray[pic]['title']
    console.log(imgL)
    myDialog.showModal()
  })
